...
# Join Slack Daily - Solution

<img src="./screen/desktop.avif" alt="Solucion preview" style="max-width: 100%; height: auto;">

Esta es una solución del proyecto **Join Slack Daily** como parte del reto de codificación #100DaysOfProjects [Front End Club](https://www.facebook.com/frontendclubfb). La mejor manera de escribir un buen código es programando todos los días🔥.
...
- [Pagina web](https://miguelramosalarcon.github.io/100DaysOfProjects/94-day-join-slack-daily/)
- [Codigo fuente]()
...
Usamos `javascript` para dar validación al input email:
